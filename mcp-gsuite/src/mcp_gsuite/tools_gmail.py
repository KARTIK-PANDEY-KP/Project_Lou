...
from . import gmail
import json
from .tool_registry import add_tool_handler
import base64
...
class SendEmailToolHandler(toolhandler.ToolHandler):
    ...
    def get_tool_description(self) -> Tool:
        return Tool(
            name=self.name,
            description="""Sends an email message directly without creating a draft first.
            
            Use this tool when you want to send an email immediately. For replies, use the reply_gmail_email tool instead.
            """,
            inputSchema={
                "type": "object",
                "properties": {
...
add_tool_handler(SendEmailToolHandler())
